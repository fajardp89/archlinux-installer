...
mount -o noatime,compress=no,subvol=@swap $ROOT_PART /mnt/swap
...
pacstrap -K /mnt base base-devel linux linux-firmware intel-ucode nano sudo networkmanager grub efibootmgr btrfs-progs git bash tzdata
